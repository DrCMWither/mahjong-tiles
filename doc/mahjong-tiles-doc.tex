...
\hypersetup{
  ...
  pdfkeywords={LaTeX, Mahjong, Riichi, MPSZF, CTAN}
}
...
\begin{table}[H]S
  ...
  \begin{tabular}{ccccccccccc}
     ...
     \textbf{f} & & \mahjong{1f} & \mahjong{2f} & \mahjong{3f} & \mahjong{4f} & \mahjong{5f} & & & &
  \end{tabular}
\end{table}
